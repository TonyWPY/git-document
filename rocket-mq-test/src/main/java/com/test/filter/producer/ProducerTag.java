package com.test.filter.producer;
...
public class ProducerTag {
    public static void main(String[] args) throws Exception {
        ...
        DefaultMQProducer producer = new DefaultMQProducer("group-filter-tag");
        ...
        for (int i = 0; i < 5; i++) {
             ...
             * content 消息内容
             */
            Message message = new Message("filter-tag", "tag", ("hello-rocketmq-filter-tag-" + i).getBytes());
            // 发送同步消息
